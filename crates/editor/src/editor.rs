...
use gpui::{
    Action, AnyElement, AnyWeakEntity, App, AppContext, AsyncWindowContext, AvailableSpace,
    Background, Bounds, ClickEvent, ClipboardEntry, ClipboardItem, Context, DispatchPhase, Entity,
    ...
    WeakEntity, WeakFocusHandle, Window, div, impl_actions, point, prelude::*, px, relative, size,
};
...
use language::{
    ...
    CursorShape, Diagnostic, DiffOptions, IndentKind, IndentSize, Language, OffsetRangeExt, Point,
...
use ui::{
    ...
    IconSize, Tooltip, h_flex, prelude::*,
};
