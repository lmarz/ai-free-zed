...
use crate::element::{LineWithInvisibles, PositionMap};
...
use gpui::{
    Action, AnyElement, AnyWeakEntity, App, AppContext, AsyncWindowContext, Background, Bounds,
    ...
    ParentElement, Pixels, Render, SharedString, Size, Styled, Subscription, Task, TextStyle,
    TextStyleRefinement, UTF16Selection, UnderlineStyle, UniformListScrollHandle, WeakEntity,
    WeakFocusHandle, Window, div, impl_actions, point, prelude::*, px, relative, size,
};
...
use language::{
    ...
    CursorShape, DiagnosticEntry, DiffOptions, IndentKind, IndentSize, Language, OffsetRangeExt,
...
use ui::{
    ButtonStyle, ContextMenu, Disclosure, IconButton, IconButtonShape, IconName, IconSize, Tooltip,
    h_flex, prelude::*,
};
...
impl Editor {
    ...
    pub fn show_word_completions(
        ...
        self.open_completions_menu(None, window, cx);
    }
    ...
    pub fn show_completions(
        ...
        self.open_completions_menu(options.trigger.as_deref(), window, cx);
    }
    ...
    fn do_completion(
        ...
        let CodeContextMenu::Completions(completions_menu) = self.hide_context_menu(cx)? else {
            return None;
        };
    ...
    fn hide_context_menu(&mut self, cx: &mut Context<Self>) -> Option<CodeContextMenu> {
        cx.notify();
