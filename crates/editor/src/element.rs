use crate::{
    ...
    DisplayRow, DocumentHighlightRead, DocumentHighlightWrite, Editor, EditorMode,
    ...
    JumpData, LineDown, LineHighlight, LineUp, OpenExcerpts, PageDown, PageUp,
    ...
    MULTI_BUFFER_EXCERPT_HEADER_HEIGHT, Direction,
};
...
use gpui::{
    ...
    GlobalElementId, Hitbox, Hsla, InteractiveElement, IntoElement, Length,
...
impl EditorElement {
    ...
    fn layout_inline_blame(
        ...
        let padding = {
            let padding = INLINE_BLAME_PADDING_EM_WIDTHS;
