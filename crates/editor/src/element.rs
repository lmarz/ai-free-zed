use crate::{
    ...
    EditorSnapshot, EditorStyle, ExpandExcerpts, FocusedBlock, GoToHunk, GoToPreviousHunk,
    GutterDimensions, HalfPageDown, HalfPageUp, HandleInput, HoveredCursor, JumpData, LineDown,
